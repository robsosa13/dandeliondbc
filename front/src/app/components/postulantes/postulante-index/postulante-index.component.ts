...
@Component({
  selector: 'app-postulante-index',
  templateUrl: './postulante-index.component.html',
  styleUrls: ['./postulante-index.component.css']
})
export class PostulanteIndexComponent implements OnInit {
